...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionBrute_force = QtGui.QAction(MainWindow)
        self.actionBrute_force.setObjectName(_fromUtf8("actionBrute_force"))
        self.actionFlann_2 = QtGui.QAction(MainWindow)
        self.actionFlann_2.setObjectName(_fromUtf8("actionFlann_2"))
        ...
        self.menuMethod.addAction(self.actionFlann_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionBrute_force.setText(_translate("MainWindow", "Brute-force", None))
        self.actionFlann_2.setText(_translate("MainWindow", "Flann", None))
